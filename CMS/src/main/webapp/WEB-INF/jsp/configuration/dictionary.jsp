...
<t:genericTemplate>
    <jsp:body>
        <script src="/CMS/resources/js/configuration/dictionaryCtrl.js"></script>
        <div ng-controller="DictionaryCtrl">
            ...
            <div class="right-addNew" id="addNew" ng-show="editMode">
                <div class="addNew-header">Dodaj lub usuń słownik</div>
                ...
                <div class="addNew-inputs">
                    ...
                    <div class="addNew-input">
                        <select ng-model="selected.dictTypeId">
                            <option ng-repeat="type in dictTypes" value="{{type.id}}">{{type.description}}</option>
                        </select>
                    </div>
                </div>
